 ...
 *
 */
package com.br.alldreams.diamantecrm.contato.domain;
...
import com.br.alldreams.diamantecrm.lead.domain.Lead;
import com.br.alldreams.diamantecrm.usuario.domain.Usuario;

/**
 * @author Jorge Demetrio
 * @version 1.0
 * @since 03/11/2015 18:24:01
 */
@Entity
...
public class Contato implements Serializable {
	 ...
	 *
	 */
	private static final long serialVersionUID = -5526488258864691277L;
	...
	@ManyToOne
	@JoinColumn(name = "id_lead", insertable = true, updatable = false, unique = false, nullable = true)
	private Lead lead;
